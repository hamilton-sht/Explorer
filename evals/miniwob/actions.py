...
async def aexecute_action(
    action: Action, page: APage, browser_ctx: ABrowserContext, obseration_processor: ObservationProcessor
) -> APage:
    ...
    match action_type:
        ...
        case ActionTypes.CLICK:
            ...
            if action["element_id"]:
                ...
                element_id = action["element_id"]
                element_center = obseration_processor.get_element_center(element_id)  # type: ignore[attr-defined]
                # logging.info(f"element center {element_center}")
...
def create_id_based_action(action_str: str) -> Action:
    ...
    match action:
        case "search_google":
            match = re.search(r"search_google ?\[(.+)\]", action_str)
            if not match:
        ...
        case "click":
            ...
            # TODO: remove hardcoded element_id
            # element_id = "38"
